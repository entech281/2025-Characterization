...
/**
 * The {@code ThriftyEncoder} class contains fields and methods pertaining to the function of the
 * absolute encoder.
 */
public class ThriftyEncoder implements AbsoluteEncoder {
  ...
  public ThriftyEncoder(int port, RelativeEncoder motorEncoder) {
    this.motorEncoder = motorEncoder;
    DriverStation.reportWarning("ANALOG THING" + port, false);
